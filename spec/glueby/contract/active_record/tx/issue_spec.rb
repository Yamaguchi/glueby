...
RSpec.describe 'Glueby::Contract::AR::Tx::Issue' do
  def setup_database
    ::ActiveRecord::Base.establish_connection(config)
    connection = ::ActiveRecord::Base.connection
    connection.create_table :issues do |t|
    ...
    connection.add_index :issues, [:txid], unique: true
  ...
  after do
    connection = ::ActiveRecord::Base.connection
    connection.drop_table :issues, if_exists: true
